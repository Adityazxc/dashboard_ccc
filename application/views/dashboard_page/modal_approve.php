<script>
    ...
    function detailImage(
        ...
        <div class="row">
            ...
            <img src="${urlPod}" class="img-thumbnail image-box" width="200">
            </div>
    ...
    function detailImage_non_approves(urlPod, awb, receiverAddress, receiverName, linkMaps, noTlp) {
        var text = "Mohon untuk memperbaiki foto validasi POD untuk paket dengan nomor AWB *" + awb + "* atas nama *" + receiverName + "* di alamat *" + receiverAddress + "* segera.";
        let content = `
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6">
                <div class="col-lg-12 "><p class="sub-header mb-0 mt-2"><strong>Foto POD Revisi</strong></p>
                    <img src="${urlRevision}" class="img-thumbnail image-box" width="200">
                </div>
            </div>
        </div>
