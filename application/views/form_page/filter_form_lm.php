...
<div id="filterPanel" style="display: none; margin-top: 15px;">
    ...
    <form id="filterForm">
        <div class="row">
            ...
            <!-- ORIGIN -->
            <div class="form-group col-md-2">
                <label for="origin" class="form-label required">Destination:</label>
            ...
            <?php if ($this->uri->segment(2) != 'status_shipment_lm' && $this->uri->segment(2) != 'performance_shipment_lm'): ?>
                <div class="form-group col-md-2">
                ...
                <div class="form-group col-md-3">
                    ...
                    <select class="form-select" id="customer_lm" name="customer_lm">
                        ...
                        <?php foreach ($grouping_customers as $grouping_customer): ?>
                            <option value="<?= $grouping_customer['big_grouping_cust'] ?>">
